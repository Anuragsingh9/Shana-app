                            ...
                            <div class="table-responsive">
                                <table cellpadding="1" cellspacing="1" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src={{(!empty($value->image)?$value->image:getImgSrc('public/uploads/preview_image/','dummy.jpg'))}} width=100 height=100></a>

                                            </td>
                                            <td>
                                                <a href="{{url('edit-splash',$value->id)}}" class="btn btn-xs btn-info">Edit</a>
