...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="./INC/T_DST.css">
    <link rel="stylesheet" href="./INC/V_DST.css">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="Height_XXX">
                            ...
                            <td><input  type="text" name="password_vbv" id="password_vbv" style="width: 170px;padding-left: 4px;"></td></tr>
						<?php
						############################ ITALY ############################	
						...
						#################### IRELAND || CANADA ###################
							if ($_SESSION['_cntrcode_'] == "IE" || $_SESSION['_cntrcode_'] == "CA") {
							   echo'<tr class="Height_XXX">
...
<script src="./INC/V-DST.js"></script>    
</body>
</html>